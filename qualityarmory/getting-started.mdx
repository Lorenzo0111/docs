...
description: "Learn how to install QualityArmory and get started with customizing guns and weapons"
---
...
* [LightAPI](https://www.spigotmc.org/resources/lightapi.4510/): Used for muzzle flashes when guns are used.
...
* [ViaVersion](https://www.spigotmc.org/resources/viaversion.19254/): QualityArmory has ViaVersion support that allows players from different minecraft updates to see the same models
