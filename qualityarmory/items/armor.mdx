...
description: "Complete reference for all armor configuration options in QualityArmory"
---

# Armor Configuration

<Info>I suggest copying another armor's configuration as a reference</Info>
