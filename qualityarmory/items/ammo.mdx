---
title: "Ammo Configuration"
description: "Complete reference for all ammo configuration options in QualityArmory"
---

# Ammo Configuration

<Info>I suggest copying another ammo's configuration as a reference</Info>
